...
function DeletedToys({deltoys}) {
  return (
    <div  style={{height:"100vh",background:"linear-gradient(to right,red 0%,pink 50%,lightgreen 50%, green 100%"}}>
    <div>
      <h2 style={{textAlign:"center"}}> LIST OF DELETED TOYS</h2>
      
      <div style={{display:"grid",gridTemplateColumns:"15rem 15rem 15rem 15rem 15rem",marginLeft:"10rem"}}>
